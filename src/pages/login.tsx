  ...
  return (
    ...
    >
      <g className="janus-portal-ring" opacity="0.9">
        <circle cx="200" cy="200" r="150" stroke="#3a52a0" strokeWidth="1" opacity="0.5" />
        <circle
          cx="200"
          cy="200"
          r="120"
          ...
          opacity="0.7"
        />
        <circle cx="200" cy="200" r="88" stroke="#6b83d6" strokeWidth="1" opacity="0.55" />
      </g>
      {/* 中心门户开口：两道相对的弧，喻「双面门神」通道。 */}
      <path d="M200 108 A92 92 0 0 1 200 292" stroke="#8fa4e6" strokeWidth="2.5" opacity="0.9" />
      <path d="M200 292 A92 92 0 0 1 200 108" stroke="#8fa4e6" strokeWidth="2.5" opacity="0.4" />
      <circle cx="200" cy="200" r="6" fill="#aebef0" />
      {/* 节点点阵 —— 网关的「连接」意象。 */}
      <g fill="#5f78ca">
  ...
  return (
    <div className="grid min-h-screen bg-white lg:grid-cols-2">
      ...
      <main className="flex items-center justify-center px-6 py-12 sm:px-12">
        <div className="janus-rise w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-gray-500">{t('login.tip')}</p>
          </div>
          ...
          <p className="mt-6 text-center text-xs text-gray-400">{t('login.qrSoon')}</p>
        </div>
      </main>
    </div>
  );
